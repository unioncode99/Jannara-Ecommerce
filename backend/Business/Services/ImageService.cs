...
namespace Jannara_Ecommerce.Business.Services
{
    public class ImageService : IImageService
    {
        ...
        Result<bool> _validateFile(IFormFile imageFile)
        {
            ...
            return new Result<bool>(true, "file_validated_successfully", true);
        }
        public Result<bool> DeleteImage(string relativePath)
        {
            if (string.IsNullOrEmpty(relativePath))
            {
                return new Result<bool>(false, "invalid_image_url", false, 500);
            }
            ...
            try
            {
                ...
                if (File.Exists(absolutePath))
                {
                    ...
                    return new Result<bool>(true, "image_deleted_successfully", true);
                }
                return new Result<bool>(false, "invalid_image_url", false, 500);
            }
            catch
