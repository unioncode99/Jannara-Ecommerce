...
namespace Jannara_Ecommerce.Business.Services
{
    public class CustomerService : ICustomerService
    {
        ...
        public async Task<Result<CustomerDTO>> CreateAsync(CustomerCreateRequestDTO customerCreateRequestDTO)
        {
            ...
            using (var connection = new SqlConnection(_connectionString))
            {
                ...
                try
                {
                    ...
                    // Create Person
                    var personResult = await _personService.AddNewAsync(personCreateDTO, profileImageUrl, connection,(SqlTransaction) transaction);
        ...
        {
            return await _repo.BecomeASeller(becomeSellerDTO);
        }
    }
}
