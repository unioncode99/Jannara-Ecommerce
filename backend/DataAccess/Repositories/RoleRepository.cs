                ...
                using (SqlCommand command = new SqlCommand(query, connection)) 
                {
                    ...
                    try 
                    {
                        ...
                        using (SqlDataReader reader = await command.ExecuteReaderAsync()) 
                        {
                            ...
                            return new Result<RoleDTO>(false, "Failed to add Role.", null);
                        }
                    } catch (Exception ex) 
                    {
                ...
                using (SqlCommand command = new SqlCommand(query, connection))
                {
                    ...
                    try
                    {
                        ...
                        using (SqlDataReader reader = await command.ExecuteReaderAsync())
                        {
                            ...
                            return new Result<RoleDTO>(false, "Failed to retrieved Role.", null);
                        }
                    }
                    catch (Exception ex)
                    {
...
";
                using (SqlCommand command = new SqlCommand(query, connection))
                {
                    ...
                    try
                    {
                        ...
                        {
                            return new Result<bool>(false, "Failed to update Role.", false);
                        }
                    }
